 ...
 *
 * <p>
 *    This is an action class with a method
 *    called when a code is read by a {@link Rebyte}.
 * </p>
 *
 * @version 1.0.0-BETA
 * @author TheShark34
 */
public interface RCodeAction {

    /**
     * Called when a code is read by Rebyte
     *
     * @param rebyte
     *            The rebyte object that read the code
     * @param code
     *            The read code
     *
     ...
     */
    void onCodeRead(Rebyte rebyte, byte code) throws RebyteMalformedBytesException;
